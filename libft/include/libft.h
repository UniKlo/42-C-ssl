...
/*   Updated: 2019/02/18 02:17:01 by khou             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						pt_putnbr(uintmax_t nb, char base);
int						pt_putnbr_fd(uintmax_t nb, char base, int fd);
int						pt_putstr(char const *s, int len);
